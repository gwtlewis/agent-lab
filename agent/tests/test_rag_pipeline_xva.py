...
from scripts.ingest_pdf import build_db_url, get_embeddings_instance, ingest_single_pdf
...
class TestRAGAgentInitialization(unittest.TestCase):
    ...
    @patch("core.agent_with_rag.RAGRetriever")
    @patch("langchain_ollama.OllamaEmbeddings")
...
class TestRAGContextFormatting(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures"""
        with patch("core.agent_with_rag.RAGRetriever"):
...
class TestRAGQueryProcessing(unittest.TestCase):
    ...
    @patch("core.agent_with_rag.IntegratedAgent.chat")
    @patch("core.agent_with_rag.RAGRetriever")
...
class TestXVASpecificQueries(unittest.TestCase):
    ...
    def test_query_cva_content(self, mock_retriever_class):
        ...
        with patch("core.agent_with_rag.IntegratedAgent.chat") as mock_chat:
